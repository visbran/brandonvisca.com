...
/*
  ...
  Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' data:; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self'; media-src 'self' https://fluxfm.streamabc.net; connect-src 'self' https://fluxfm.streamabc.net; frame-src 'none'; object-src 'none'; base-uri 'self'; form-action 'self'
"""
