...
**Brandon Visca**  
Site : [brandonvisca.com](https://brandonvisca.com)  
Contact : contact@brandonvisca.com
...
Cloudflare collecte automatiquement des **logs de connexion** (adresse IP, navigateur, pages visitées) à des fins de sécurité et de performance réseau. Ces données sont traitées par Cloudflare conformément à son [Data Processing Addendum](https://www.cloudflare.com/cloudflare-customer-dpa/).

Cloudflare est certifié **EU-US Data Privacy Framework**. Le transfert de données vers les États-Unis est encadré par les clauses contractuelles types de la Commission européenne.
...
Pour exercer ces droits ou pour toute question relative à la protection de vos données, contactez : **contact@brandonvisca.com**
