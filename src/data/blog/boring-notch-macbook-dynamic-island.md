...
Si tu as plusieurs écrans et que tu cherches à optimiser leur rendu, j'ai testé [BetterDisplay macOS hidpi](/betterdisplay-macos-hidpi-ddc/) qui force le HiDPI et active le contrôle DDC sur les écrans externes. Parfait complément quand tu veux une qualité d'affichage pro sur du matériel tiers.
