...
# ITSM pour débutants : pourquoi votre Excel va finalement vous rendre fou (guide survie)
Ton collègue vient de formater accidentellement le PC qui contenait **LE** fichier Excel de l'inventaire ? Celui avec tous les numéros de série, les dates d'achat, les garanties qui expirent demain et les mots de passe "temporaires" vieux de 3 ans ? 

Félicitations, tu viens de découvrir pourquoi l'**ITSM pour débutants** existe. Et spoiler : c'est pas pour faire joli dans ton CV.
...
Contrairement à certains outils enterprise, la communauté SnipeIT produit beaucoup de contenu en français. Tu ne seras pas coincé avec de la doc en anglais technique.
