...
faqs:
  ...
  - question: "Peut-on importer un inventaire Excel existant dans Snipe-IT ?"
    answer: "Oui. Snipe-IT propose un import CSV natif. Mappe les colonnes de ton Excel (nom, numéro de série, modèle, assignation) avec les champs Snipe-IT, puis importe le fichier depuis l'interface admin."
