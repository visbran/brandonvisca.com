---
title: "Omarchy Linux : test complet de la distro Arch"
description: "Omarchy Linux installé en 20 minutes et testé : ce que la distro Arch clé en main fait bien, et ses trois limites (Hyprland, jeunesse, doc)."
...
<GalleryEmbed slug="omarchy-install" cols={3} limit={0} showLink={false} />
