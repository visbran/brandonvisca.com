...
- [📜 Arc Browser : L’histoire d’un navigateur révolutionnaire (2022-2025)](#le-grand-abandon-d-arc-browser)
  ...
  - [Arc Search : L’expérimentation mobile (2024)](#arc-search-lexperimentation-mobile-2024)
  - [L’expansion Windows 11 (2024)](#lexpansion-windows-11-2024)
  - [L’abandon brutal : Dia, le nouveau projet (2025)](#labandon-brutal-dia-le-nouveau-projet-2025)
  - [Ce qu’il faut retenir de l’aventure Arc](#ce-quil-faut-retenir-de-laventure-arc)
- [Ce qu’on aimait tous dans Arc Browser](#ce-quon-aimait-tous-dans-arc-browser)
- [SigmaOS : L’alternative la plus directe](#sigma-os-lalternative-la-plus-directe)
- [Zen Browser : Firefox customisé comme un chef](#zen-browser-firefox-customise-comme-un-chef)
- [Stack Browser : L’organisation poussée à l’extrême](#stack-browser-lorganisation-poussee-a-lextreme)
- [Orion Browser : Le retour de WebKit](#orion-browser-le-retour-de-web-kit)
- [Brave Browser avec customisation](#brave-browser-avec-customisation)
- [Firefox avec extensions minimalistes](#firefox-avec-extensions-minimalistes)
- [Comment choisir ta nouvelle arme ?](#comment-choisir-ta-nouvelle-arme)
- [Migration : récupérer tes données d’Arc](#migration-recuperer-tes-donnees-d-arc)
...
- Optimisation des performances sur du matériel hétérogène
- Intégration avec les fonctionnalités Windows 11 (Snap Layouts, widgets)
- Adaptation des raccourcis clavier (Cmd → Ctrl)
- Gestion des différences WebKit vs Chromium
...
- Problèmes de monétisation (freemium qui n’a jamais vraiment pris)
- Coûts de maintenance de 3 bases de code (macOS, iOS, Windows)
- Équipe dev étirée sur trop de fronts
- Levées de fonds qui poussent au pivot rapide
...
[SigmaOS](https://sigmaos.com/) reprend pratiquement tous les concepts d’Arc Browser. Interface sidebar, espaces de travail, split view natif, raccourcis clavier extensifs. C’est littéralement le successeur spirituel d’Arc.

**Points forts :**

- Split screen multi-directionnels (horizontal, vertical, grille)
...
- macOS exclusivement (désolé pour les utilisateurs Windows/Linux)
- Modèle freemium avec limitations
- Encore quelques bugs sur les sites complexes
...
// Dans brave://settings/
- Désactiver la barre de favoris
- Masquer le bouton Brave Rewards  
- Activer les onglets verticaux (Labs)
...
[Firefox](https://firefox.com) reste customisable à l’extrême. Avec les bonnes extensions et un thème adapté, tu peux recréer 80% de l’expérience Arc.
...
/* Masquer la barre d'onglets si Tree Style Tab actif */
#TabsToolbar {
