...
Questions ou configs avancées ? Les commentaires sont ouverts. Et si tu veux synchroniser en temps réel tes fichiers entre tes appareils sans cloud, j'ai aussi testé [Syncthing avec Docker](https://brandonvisca.com/syncthing-docker-synchronisation-fichiers/), P2P chiffré, simple et sans serveur central.
